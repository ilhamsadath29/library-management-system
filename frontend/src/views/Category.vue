    ...
    <PageComponent>
        <template v-slot:header>
            <div class="flex justify-between items-center">
                ...
                <router-link :to="{name: 'CategoryCreate'}" class="py-2 px-3 text-white bg-emerald-500 rounded-md hover:bg-emerald-600">
...
function deleteItem(data) {
    if (confirm("Are you want to delete this?")) {
        store.dispatch("deleteCategory", data.id).then(
